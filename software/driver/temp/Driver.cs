...
//
// ASCOM Focuser driver for VoightFocuser
//
...
namespace ASCOM.VoightFocuser
{
    //
    // Your driver's DeviceID is ASCOM.VoightFocuser.Focuser
    //
    // The Guid attribute sets the CLSID for ASCOM.VoightFocuser.Focuser
    // The ClassInterface/None addribute prevents an empty interface called
    // _VoightFocuser from being created and used as the [default] interface
    //
    ...
    /// ASCOM Focuser Driver for VoightFocuser.
    /// </summary>
    [Guid("024ef035-0e70-489a-a0e3-5440b60ad6cd")]
    ...
    public class Focuser : IFocuserV2
    {
        ...
        /// </summary>
        internal static string driverID = "ASCOM.VoightFocuser.Focuser";
        // TODO Change the descriptive string for your driver then remove this line
        /// <summary>
        /// Driver description that displays in the ASCOM Chooser.
        /// </summary>
        private static string driverDescription = "ASCOM Focuser Driver for VoightFocuser.";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VoightFocuser"/> class.
